...
(function(){
    ...
    publicResourceLoader =new PublicResourceLoader({
        css:[resourceUrl+'resource/index.css?version='+Math.random()],
        scripts:[
            'http://libs.baidu.com/jquery/2.0.0/jquery.min.js',
            //'http://www.duopao.com/second/js/server.js?version='+Math.random(),
            resourceUrl+'resource/adSceneInGames.js?version='+Math.random()
//            resourceUrl+'resource/game_index.js?version='+Math.random()
        ]
    });
}());
